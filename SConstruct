...
dbg.Program(["vegcat.c", "preproc.c", "talign.c", "decompose.c", "grid.c", "fitter.c", "eval.c", "interpolate.c", "matinv.c", "read_basis.c", "utils.c", "config.c", "fal.c", "diagcnt.c", "log.c", "lh.c", "wrap.c", "oneInt.c"])
dbg.Program(["vegcat_basis.c", "preproc.c", "talign.c", "decompose.c", "grid.c", "fitter.c", "eval.c", "interpolate.c", "matinv.c", "read_basis.c", "utils.c", "config.c", "fal.c", "diagcnt.c", "log.c", "lh.c", "wrap.c", "oneInt.c"])
